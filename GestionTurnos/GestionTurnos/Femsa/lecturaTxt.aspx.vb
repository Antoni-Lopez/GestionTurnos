...
Public Class lecturaTxt
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        '    Dim name_BD As String, apellidos_BD As String, registrado_BD As String, nameQr_BD As String
        ...
        '                VectorSQL(0) = "UPDATE eecontactes SET Nom = '" & clsBD.Cometes(Left(name_imp, 100)) & "',Cognoms='" & clsBD.Cometes(Left(ape_imp, 100)) & "',Carrec='" & registro_imp & "',Password='" & pass_imp & "',Procedencia='" & nameQr_imp & "' WHERE Email = '" & clsBD.Cometes(Left(mail_imp, 100)) & "' And idFira ='" & idferia & "'"
        ...
        '                                            "" & alojamiento & ",'" & nameQr_imp & "','" & clsBD.Cometes(Left(alergia, 100)) & "','" & clsBD.Cometes(Left(observaciones, 100)) & "')"
